                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 group">
                            <div className="size-12 rounded-xl bg-purple-700 flex items-center justify-center group-hover:bg-purple-900 transition-colors">
                    ...
                    <form onSubmit={HandleSubmit} className="space-y-6 w-full">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-purple-800 text-white py-2 rounded-md hover:bg-purple-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                        >
                            {isSignUp ? (
                                <>
